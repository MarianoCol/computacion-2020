...
class TestProducto(unittest.TestCase):
    ...
    @parameterized.expand([
        (200000, {'_descripcion': 'samsung s10', '_precio': 200000,'_tipo': 'celular'}),
        (400000, {'_descripcion': 'samsung s20', '_precio': 400000, '_tipo': 'celular'})
    ])

    def test_busqueda_binaria(self, precioBuscado, producto):
        busqueda = ProductoService().\
         busquedaBinaria(Repositorios.productosList, precioBuscado)
